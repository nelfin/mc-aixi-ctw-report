...
\begin{figure}
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[smooth,/pgfplots/no markers,legend style={
                                               cells={anchor=east},
                                               legend pos=outer north east,
                                               }]
        \foreach \p in {0_0, 0_2, 0_4, 0_6, 0_8, 1_0} {
        \addplot table {graph_data/coinflip_p=\p.plot.csv};
        \addlegendentryexpanded{$p = \p$}
        }
      \end{axis}
    \end{tikzpicture}
  \end{center}
