...
\end{figure}
Another graph with $\theta = 1$ is shown in Figure \ref{fig:coin_1_0}. With $\theta = 1$, the maximum theoretical reward is $1$, with the strategy of picking 1 always. We can see that our implementation of \mac{} quickly converges to this strategy of picking 1 always, with the average reward approaching 1 (the maximum possible reward).
...
>>>>>>> d7cb7be1bb5ca4710f837b20f40a3f507a622ddc
...
\end{tabular}\\
\vspace{0.5mm}
Table 4.6: The parameters used in the Grid world environment.
\end{center}
...
\end{tabular}\\
\vspace{0.5mm}
Table 4.4: The parameters used in the RPS environment.
\end{center}
...
\end{tabular}\\
\vspace{0.5mm}
Table 4.5: The parameters used in the Kuhn Poker environment.
\end{center}
...
\end{tabular}\\
\vspace{0.5mm}
Table 4.5: The parameters used in the Pacman environment.
\end{center}
